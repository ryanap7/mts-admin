        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">Admin Panel</span>
                </a>
                        ...
                        <li class="nav-item">
                            <a href="/apps/brand" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Brand</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/apps/mailbox" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Category</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/apps/scrumboard" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Product</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    <a href="/charts" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Portfolio</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
                    <a href="/charts" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Statistic</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
