        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="/admin/brands" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Brands</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <li class="menu nav-item">
                    <a href="/admin/statistics" class="nav-link group">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Statistics</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
                    <a href="/admin/contacts" class="nav-link group">
                        <div class="flex items-center">
