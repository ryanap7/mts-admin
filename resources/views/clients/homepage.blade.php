                ...
                <div class="container-hero-bmw">
                    ...
                    >
                        <img
                            ...
                            class="bgnewhero"
                            alt="https://unsplash.com/s/photos/meet?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText"
                        />
                    </a>
                ...
                <div class="slider-container">
                    <div class="slider">
                            <img
                                class="unOurCus"
                                id="diskominfo"
                                src="./assets/images/diskominfo.webp"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                                id="trisakti"
                                src="./assets/images/trisakti.webp"
                                alt="sponsor"
                            />
                            <img
                                class="ourCus"
                                id="mensa"
                                src="./assets/images/Our Cus Mensa.png"
                                alt="sponsor"
                            />
                            <img
                                class="ourCus"
                                id="landison"
                                src="./assets/images/Our Cus Landson.png"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                                id="otto"
                                src="./assets/images/otto.webp"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                                id="andini"
                                src="./assets/images/andini.webp"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                                id="akr"
                                src="./assets/images/akr.webp"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                                id="indocapital"
                                src="./assets/images/indocapital.webp"
                                alt="sponsor"
                            />
                            <img
                            id="succor"
                                src="./assets/images/succor.webp"
                                alt="sponsor"
                            />
                            <img
                                class="ourCus"
                                id="planetBan"
                                src="./assets/images/Our Cus Planetban.png"
                                alt="sponsor"
                            />
                            <img
                                class="ourCus"
                                id="smr"
                                src="./assets/images/Our Cus SMR.png"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                                id="rukun"
                                src="./assets/images/rukun.webp"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                                id="gmf"
                                src="./assets/images/gmf.webp"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
                            ...
                            <img
                                class="unOurCus"
                                id="ubm"
                                src="./assets/images/ubm.webp"
                                alt="sponsor"
                            />
                            <img
                                class="ourCus"
                                id="cas"
                                src="./assets/images/Our Cus CAS.png"
                                alt="sponsor"
                            />
                            <img
                                class="unOurCus"
