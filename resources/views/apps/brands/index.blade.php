<x-layout.default>
    ...
    <div x-data="brands">
        ...
        <div class="panel" id="content-panel">
            <div class="flex">
                <h5 class="md:mb-0 mb-5  mr-7 font-semibold text-lg dark:text-white-light">Brands
                </h5>
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("brands", (initialOpenState = false) => ({
                datatable: null,
                no: 1,
                        ...
                        .then(data => {
                            ...
                            const formattedData = data.map(brand => {
                                return [
                                    this.renderNumber(),
                                    brand.name,
                                    this.renderActions(brand.id),
                                ];
                            });

                            this.datatable = new simpleDatatables.DataTable('#myTable', {
                                data: {
                                    headings: ["No.", "Name", "Action"],
                                    data: formattedData,
                                },
                                sortable: true,
                                searchable: true,
